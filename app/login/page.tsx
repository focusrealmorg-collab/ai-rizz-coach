    ...
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: 24 }}>
      ...
      <div style={{ width: "100%", maxWidth: 400 }}>
        <div style={{ textAlign: "center", marginBottom: 40 }}>
          ...
          <p style={{ color: "var(--text-secondary)", fontSize: 15 }}>Your wingman missed you</p>
        </div>
        ...
        <div className="glow-card" style={{ padding: 32, borderRadius: 20 }}>
          <form onSubmit={handleLogin} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            <div>
              ...
              <div style={{ position: "relative" }}>
                ...
                <input
                  ...
                  style={{ width: "100%", padding: "12px 14px 12px 40px", fontSize: 15 }}
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div style={{ position: "relative" }}>
                ...
                <input
                  ...
                  required
                  className="input-field"
                  style={{ width: "100%", padding: "12px 44px 12px 40px", fontSize: 15 }}
                />
            ...
            {error && (
              <div style={{ padding: "10px 14px", borderRadius: 8, background: "rgba(255,71,87,0.1)", border: "1px solid rgba(255,71,87,0.2)", color: "#ff4757", fontSize: 14 }}>
                {error}
              </div>
            )}
        ...
        <p style={{ textAlign: "center", marginTop: 20, fontSize: 14, color: "var(--text-muted)" }}>
          ...
          <Link href="/signup" style={{ color: "var(--accent-gold)", textDecoration: "none", fontWeight: 600 }}>Sign up</Link>
        </p>
      </div>
    </div>
  );
